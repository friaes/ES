...
public class ParticipationController {
    ...
    @GetMapping(value = "/activities/{activityId}/participations")
    ...
    @PostMapping(value = "/activities/{activityId}/participations")
    @PreAuthorize("(hasRole('ROLE_MEMBER')) and hasPermission(#activityId, 'ACTIVITY.MEMBER')")
    ...
    @GetMapping(value = "/activities/myparticipations")
